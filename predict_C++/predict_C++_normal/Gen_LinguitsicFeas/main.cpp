...
int main()
{
    ...
    LAB_INFO *Lab_Infoo = new LAB_INFO[MAX_Lab_NUM];
    ...
    for (int i = 0; i < Sent_Num; i++)
    {
        ...
        memset(Lab_Infoo, 0, sizeof(LAB_INFO)*MAX_Lab_NUM);
        ...
        Label_Num = LoadFullLab(sz_InputLabFile, Lab_Infoo);
        AnswerQues(Answer_Data, Lab_Infoo, Ques_Infoo, Label_Num, Ques_Num);
